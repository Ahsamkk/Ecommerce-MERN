...
const Footer = () => {
  return (
    <footer className="border-t py-12 border-gray-400 px-4">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-0">
        <div className="a">
          ...
          <form className="flex">
            <input type="email" placeholder="Enter your email" className="p-3 w-full text-sm border-t border-l border-bottom border-gray-300 rounded-l-md focus:outline-none focus:ring-2 focus:ring-gray-500 transition-all" />
            <button type="submit" className="bg-black text-white px-6 py-3 text-sm rounded-r-md hover:text-gray-800 transition-all">Submit</button>
          </form>
        </div>
        ...
        <div>
          ...
          <div className="flex items-center space-x-4 mb-6">
            <a href="facebook.com" target="_blank" rel="noopener noreferrer" className="hover:text-gray-500">
      ...
      <div className="container mx-auto mt-12 px-4 lg:px-0 border-t border-gray-200 pt-6">
        <p className="text-gray-500 text-sm tracking-tighter text-center">2025, AKK, All Rights Reserved.</p>
      </div>
    </footer>
  )
}
